...
def run(chain_id, config_selection, endpoint, include_data, unknown_dict):
    raise Exception ("Validation is no longer supported. The code is left for later integration into a unit test repository, or other removal. This decision has not been made yet.")
    endpoints = None
    if endpoint != None:
        endpoints = [endpoint]
